...
plot = ggplot(simulation, aes(x = time)) + 
  geom_line(aes(y = Sm, colour = "Sm"), size=2, alpha=1) + 
  geom_line(aes(y = S1R2, colour = "S1R2"), size=2, alpha=1) + 
  geom_line(linetype="dotted", aes(y = S2R1, colour = "S2R1"), size=2, alpha=1) +
  geom_line(aes(y = Im, colour = "Im"), size=2, alpha=1) +
  geom_line(aes(y = I1, colour = "I1"), size=2, alpha=1) +
  geom_line(linetype="dotted", aes(y = I2, colour = "I2"), size=2, alpha=1) + 
  geom_line(aes(y = I1R2, colour = "I1R2"), size=2, alpha=1) +
  geom_line(linetype="dotted", aes(y = I2R1, colour = "I2R1"), size=2, alpha=1) +
  geom_line(aes(y = Rm, colour = "Rm"), size=2, alpha=1) +
