...
SIR <- function(t, x, parms){
  ...
  with(as.list(c(parms,x)),{
    ...
    dR <- r*I - d*R +d*I + g*I #a g*I nem jó itt, az S és az R között kéne valahogy arányosan elosztanom, de ezt nem értettem pontosan, ojra rá kell kérdeznem!!!      # Note: because S+I+R=constant, this equation could actually be omitted,
