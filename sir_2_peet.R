...
for(i in 1:5) {
  for(j in 1:5) {
    ...
    plot(dt, S, type="l", col="blue", ylim=c(0,sum(inits)), main = c(paste(index, "."), paste("R0: ", R_0), paste("Beta: ", parms[1]), paste("r: ", parms[2])), xlab="time", ylab="number of individuals",lwd=3)
